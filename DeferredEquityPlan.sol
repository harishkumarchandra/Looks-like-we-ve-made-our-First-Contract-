...
contract DeferredEquityPlan {
    ...
    function distribute() public {
        ...
        // Your code here!
        require(unlock_time <= now, "unlock_time should be less than or equal to now");
        require(distributed_shares < total_shares, "distributed_shares is less than the total_share");
